  ...
  return (
    <Box display="flex" flexDir="row" width="100%" marginBottom="1.2rem">
      <Box textAlign="center" width="30%" display="flex" alignItems="center">
        <Text textColor="white" transform="rotate(180deg)" fontFamily="Megrim" minW={"100%"} fontSize={{ base: "1.5rem", md: "2rem", lg: "2.5rem", xl: "3rem", "2xl": "3.5rem" }} style={{writingMode:"vertical-rl",textOrientation:"sideways-right"}} >
          Day-{props.num}
        </Text>
      </Box>
